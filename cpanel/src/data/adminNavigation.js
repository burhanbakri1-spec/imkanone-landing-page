...
export const tenantNavigation = Object.freeze([
  ...
  placeholder("tenant", "inbox", "Inbox", "البريد الوارد", "inbox"),
  group("tenant-customers-leads", "Customers & Leads", "العملاء والعملاء المحتملون", "contactRound", [
    ...
    placeholder("tenant", "customers/forms", "Forms & Submissions", "النماذج والطلبات", "listTodo"),
    placeholder("tenant", "customers/meetings", "Meetings", "الاجتماعات", "video"),
    placeholder("tenant", "customers/pipelines", "Pipelines", "مسارات العملاء", "gitBranch"),
    placeholder("tenant", "customers/community", "Community", "المجتمع", "users"),
    placeholder("tenant", "customers/loyalty", "Loyalty Program", "برنامج الولاء", "heartHandshake"),
  ...
  group("tenant-analytics", "Analytics", "التحليلات", "chartNoAxesCombined", [
    placeholder("tenant", "analytics/highlights", "Highlights", "أبرز النتائج", "sparkles"),
    placeholder("tenant", "analytics/realtime", "Real-time", "الوقت الفعلي", "radio"),
    placeholder("tenant", "analytics/traffic", "Traffic", "الزيارات", "mousePointerClick"),
    placeholder("tenant", "analytics/behavior", "Behavior", "السلوك", "route"),
    placeholder("tenant", "analytics/marketing", "Marketing", "التسويق", "megaphone"),
    placeholder("tenant", "analytics/recordings", "Session Recordings", "تسجيلات الجلسات", "screenShare"),
    placeholder("tenant", "analytics/insights", "Insights", "الرؤى", "lightbulb"),
    placeholder("tenant", "analytics/benchmarks", "Benchmarks", "المعايير", "scale"),
    existing("admin-reports", "All Reports", "كل التقارير", "files", { requiresModule: true }),
  ]),
